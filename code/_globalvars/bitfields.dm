...
DEFINE_BITFIELD(supports_variations_flags, list(
	...
	"CLOTHING_TESHARI_VARIATION" = CLOTHING_TESHARI_VARIATION,
))

DEFINE_BITFIELD(open_directions, list(
	"NORTH" = NORTH,
	"SOUTH" = SOUTH,
	"EAST" = EAST,
	"WEST" = WEST,
...
DEFINE_BITFIELD(z_flags, list(
	"Z_ATMOS_IN_UP" = Z_ATMOS_IN_UP,
	"Z_ATMOS_IN_DOWN" = Z_ATMOS_IN_DOWN,
	"Z_ATMOS_OUT_UP" = Z_ATMOS_OUT_UP,
	"Z_ATMOS_OUT_DOWN" = Z_ATMOS_OUT_DOWN,
	"Z_MIMIC_BELOW" = Z_MIMIC_BELOW,
	"Z_MIMIC_OVERWRITE" = Z_MIMIC_OVERWRITE,
	"Z_MIMIC_NO_AO" = Z_MIMIC_NO_AO,
